        ...
        for calendar_month_index in range(12):
            ...
            if not math.isnan(monthly_values[year_index, calendar_month_index]):
                ...
                if monthly_values[year_index, calendar_month_index] < 0.0005:
                    ...
                    pe3_shape = monthly_pearson_values[
                        1, calendar_month_index]  # first Pearson Type III parameter, shape
                    pe3_location = monthly_pearson_values[
                        2, calendar_month_index]  # second Pearson Type III parameter, location
                    pe3_scale = monthly_pearson_values[
                        3, calendar_month_index]  # third Pearson Type III parameter, scale
